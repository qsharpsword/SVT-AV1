...
static void get_me_distortion(int *me_32x32_subblock_vf, int *me_16x16_subblock_vf, uint8_t *pred_y,
    ...
    for (uint32_t index_32x32 = 0; index_32x32 < 4; index_32x32++) {
        ...
        me_32x32_subblock_vf[index_32x32] = fn_ptr->vf(
            pred_y_ptr, stride_pred_y, src_y_ptr, stride_src_y, &sse);
    }
    ...
    for (uint32_t index_16x16 = 0; index_16x16 < 16; index_16x16++) {
        ...
        me_16x16_subblock_vf[index_16x16] = fn_ptr->vf(
            pred_y_ptr, stride_pred_y, src_y_ptr, stride_src_y, &sse);
    }
}
...
static void get_me_distortion_highbd(int *me_32x32_subblock_vf, int *me_16x16_subblock_vf,
    ...
    for (uint32_t index_32x32 = 0; index_32x32 < 4; index_32x32++) {
        ...
        me_32x32_subblock_vf[index_32x32] = variance_highbd_c(
            pred_y_ptr, stride_pred_y, src_y_ptr, stride_src_y, 32, 32, &sse);
    }
    ...
    for (uint32_t index_16x16 = 0; index_16x16 < 16; index_16x16++) {
        ...
        me_16x16_subblock_vf[index_16x16] = variance_highbd_c(
            pred_y_ptr, stride_pred_y, src_y_ptr, stride_src_y, 16, 16, &sse);
    }
}
#endif
